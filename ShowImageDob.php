<!-------IMAGE MODAL CONTENT------->
    ...
    <div class="modal-content" id="ModalImageDob" data-dismiss="modal" role="dialog" style="width: 1080px; height: 650px; display:none">
        <div class="modal-header text-info">
            <label class="label-control fa fa-hotel"> Rooms Profile</label>
            <div class="btn-group-toggle">
                <a href="DoubleRoom.php" class="btn btn-secondary BtnSm fa fa-check-circle HideImageDel"> Check In</a>
                <button class="btn btn-secondary BtnSm fa fa-close HideImageDob"> Close</button>
            </div>
        </div>
        <div class="modalC-body">
            <div class="row">
               <div class="col-sm-8">
                   <img with="500px;" height="465px" src="img/3206101.jpg">
               </div>
               <div class="col-4">
                        ...
                        <div class="alert-heading">
                            <div class="input-group">
                               <div class="input-group-prepend">
                                   <span class="input-group-text">SINGLE ROOM</span>
                               </div>
                               <span class="input-group-text"> P1000.00</span>
                               <a href="SingleRoom.php" class="btn btn-secondary fa fa-angle-double-right float-right"> Info</a>  
                           </div>
                        </div>
                        <hr>
                        <p>
