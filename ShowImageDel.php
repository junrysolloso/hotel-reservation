<!-------IMAGE MODAL CONTENT------->
    ...
    <div class="modal-content" id="ModalImageDel" data-dismiss="modal" role="dialog" style="width: 1080px; height: 650px; display:none">
        <div class="modal-header text-info">
            <label class="label-control fa fa-hotel"> Rooms Profile</label>
            <div class="btn-group-toggle" float-right>    
                <a href="DeluxeRoom.php" class="btn btn-secondary BtnSm fa fa-check-circle  HideImageDel"> Check In</a>
                <button class="btn btn-secondary BtnSm fa fa-close  HideImageDel"> Close</button>
            </div>
        </div>
        <div class="modalC-body">
            <div class="row">
               <div class="col-sm-8">
                   <img with="500px;" height="465px" src="img/bg1.jpg">
               </div>
               <div class="col-4">
                   <div class="alert alert-primary">
                        <div class="alert-heading">
                            <div class="input-group">
                               ...
                               <span class="input-group-text">P1500.00</span>
