        ...
        <div class="Containerbox">
            <div class="row">
                <div class="col-sm-8 border-right">
                    ...
                    <img width="100%" height="500px" src="img/SetWidth760-Grand-hotel-Union-Deluxe-Single-2-Room.jpg">
                    <hr>
                    <div class="row">
                        <div class="col-sm-4">
                    ...
                    <p>
                        ...
                        <span class="fa fa-angle-double-right"> </span> Bedding : One single bed<br>
                        <span class="fa fa-angle-double-right"> </span> Capacity : 2 persons<br>
                        <span class="fa fa-angle-double-right"> </span> Surface : 15 m²<br>
                        ...
                        <span class="fa fa-angle-double-right"> </span> Price: P650 / 12 hours add P500 for 24 hours
                    </p>

                    <hr>
                    <p>
                        The single room has a surface of 15 m² and is located in the historical part of the hotel. The elegant furnishing and sophisticated colors give the room a warm glow. The room is equipped with an espresso machine and marble bathroom with l'Occitane room amenities.
                    </p>
                    <hr>
                    </div>
                </div>
